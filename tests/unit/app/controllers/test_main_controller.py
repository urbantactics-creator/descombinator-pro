...
class TestMainController:
    ...
    def test_handle_file_dropped_success(self, main_controller):
    ...
    def test_handle_file_dropped_nonexistent_file(self, main_controller):
    ...
    def test_set_loaded_audio(self, main_controller):
    ...
    def test_update_settings(self, main_controller):
        """Test updating settings."""
        new_settings = {"output_dir": "/custom/output", "theme": "light", "segment": 10}
