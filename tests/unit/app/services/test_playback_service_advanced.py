...
class TestPlaybackServiceConcurrency:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_play_pause_stop(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_set_source_set_stems(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_volume_changes(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_mute_unmute(
        self
    ) -> None:
        ...
        tasks = [
            ...
            asyncio.create_task(asyncio.to_thread(svc.set_track_muted, "vocals", False)),
    ...
    @pytest.mark.asyncio
    async def test_concurrent_active_stems_changes(
        self
    ) -> None:
        ...
        tasks = [
            ...
            asyncio.create_task(asyncio.to_thread(svc.set_active_stems, ["vocals", "drums"])),
    ...
    @pytest.mark.asyncio
    async def test_concurrent_seek_operations(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_playback_service_thread_safety(
        self
    ) -> None:
        ...
        async def rapid_operations():
            ...
            for i in range(50):
                if i % 5 == 0:
                    ...
                    tasks.append(asyncio.create_task(asyncio.to_thread(svc.set_master_volume, i / 100.0)))
                else:
                    tasks.append(asyncio.create_task(asyncio.to_thread(svc.seek_ms, i * 100)))
    ...
    @pytest.mark.asyncio
    async def test_playback_service_state_consistency(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_playback_service_error_handling_under_concurrency(
        self
    ) -> None:
